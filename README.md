# Ghost: DeFi GHOST Analytics with Python (v 0.0.16)
...
## Docs
Visit [Ghost docs](https://ghost.org) for full documentation with walk-through tutorials
...
```
> git clone https://github.com/drsin/ghost
> pip install .
```
or
```
